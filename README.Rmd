...
[![Travis-CI Build Status](https://travis-ci.org/hypertidy/quadmesh.svg?branch=master)](https://travis-ci.org/hypertidy/quadmesh)
...
* fast polygonization of individual cells, in [https://CRAN.R-project.org/package=spex](spex::polygonize). 
